...
import finalProject.entities.Directory;
...
public class FileOptionsScreen implements Screen {
    ...
    public FileOptionsScreen() {
    	...
    	options.add("1. Adding a File");
        options.add("2. Delet A File");
		...
		try {
			...
			File file = new File(dir.getName() + fileName);
		      ...
		      if (file.createNewFile()) {
		        ...
		        System.out.println("This File Already Exits, so we cant add again eith same name");
		      }
		}catch (IOException e){
